...
- <code>reg_noise</code>: regularization term of noise. Default is 1.0. For smaller hidden factors, this noise can be set to 0.5 if you observe non-boosting results. Normally setting to 1.0 is fine as we have an automatic flexible noise maganitude.
- <code>eps</code>: noise magnitude. Default is 1.0.
- <code> </code>:
- <code> </code>:
